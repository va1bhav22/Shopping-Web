...
const reviews = () => {
  const { data, mutate } = useSWRAPI(`/review/all/reviews`)
    ...
    <AdminLayout title="Admin | Reviews">
      <div className="m-auto px-8 py-4">
        <MaterialTable
          ...
          title={
            <h1 className="text-lg font-bold text-theme">Manage Reviews</h1>
          }
          isLoading={!data}
          data={
            reviews === null
          ...
          detailPanel={({ rowData }) => {
            return (
              <div className="bg-eef5f9 m-auto p-[20px]">
                ...
                >
                  <CardContent>
                    <h1 className="mb-[5px] text-lg text-theme">Comments </h1>
