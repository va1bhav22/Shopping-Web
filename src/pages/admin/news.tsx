...
const news = () => {
  const { data, error, mutate } = useSWRAPI('newses', {
  ...
  const newses = data?.data?.data?.data
  return (
    <AdminLayout title="Admin | Manage News">
      <div className="m-auto px-4 py-4">
        <MaterialTable
          ...
          title={
            <div className="text-lg font-bold text-theme">Manage News</div>
          }
          isLoading={!data}
          data={
            newses === null
