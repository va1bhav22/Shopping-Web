...
const RefundPolicy = () => {
  return (
    <PublicLayout title="Refund Policy | Prizen">
      <CommonBanner title="Refund Policy" />
      <article className="flex w-full flex-col items-center py-11">
        <div className="prose prose-sm">
          <h1>Return and Refund Policy</h1>
          <p>Last updated: September 23, 2022</p>
          <p>Thank you for shopping at Prizen website and Prizen app.</p>
          <p>
            ...
            <a
              ...
              target="_blank"
            >
              Free Return and Refund Policy Generator
            </a>
            .
          </p>
          <p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Prizen, Near Satya Sai Enclave,
                House No: HIG-66, AMRI Hosp Road, Kolathia, Khandagiri,
                Bhubaneswar, Odisha, 75100.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Prizen, accessible from{' '}
                <a
                  href="https://prizen.vercel.app"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://prizen.vercel.app
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              <p>By email: contact.cgh2022@gmail.com</p>
            </li>
            <li>
              <p>
                By visiting this page on our website:{' '}
                <a
                  href="https://prizen.vercel.app/contact"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://prizen.vercel.app/contact
                </a>
              </p>
            </li>
            <li>
              <p>By phone number: +91-9373054469 </p>
            </li>
          </ul>
          <p>
